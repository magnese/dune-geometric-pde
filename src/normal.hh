...
{
  static auto compute(const EntityType& entity)
  {
...
// helper function
template<typename EntityType>
inline auto computeNormal(const EntityType& entity)
{
  return Normal<EntityType,EntityType::Geometry::coorddimension>::compute(entity);
}
